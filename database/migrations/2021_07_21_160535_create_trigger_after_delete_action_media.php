...
class CreateTriggerAfterDeleteActionMedia extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("
           ...
           CREATE OR REPLACE TRIGGER trigger_after_delete_action_media
               AFTER DELETE
    ...
    {
        DB::unprepared('DROP TRIGGER `trigger_after_delete_action_media`');
    }
}
